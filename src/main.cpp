...
byte knownKeys[NR_KNOWN_KEYS][MFRC522::MF_KEY_SIZE] =  {
    ...
    {0xD3, 0xF7, 0xD3, 0xF7, 0xD3, 0xF7}, // A0 A1 A2 A3 A4 A5
...
void setup() {
    Serial.begin(9600);
    while (!Serial);            //Skippen voor als de Serial port is geopent
    SPI.begin();
    mfrc522.PCD_Init();
